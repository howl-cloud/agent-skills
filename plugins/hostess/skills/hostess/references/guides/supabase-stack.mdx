...
✓ Deployment complete
  ...
  kong: https://supabase-kong-amber-lake.hostess.run
```
...
```text
https://supabase-kong-amber-lake.hostess.run
```
...
export SUPABASE_URL="https://supabase-kong-amber-lake.hostess.run"
```
...
- **[Managing Secrets](/guides/managing-secrets)** - Rotate generated Supabase keys and credentials
- **[Custom Domains](/guides/custom-domains)** - Put your own domain in front of Kong
- **[Connect to Services](/guides/connect-to-services)** - Debug internal services from your machine
- **[Backups & Restore](/guides/backups-and-restore)** - Configure database backup and restore workflows
