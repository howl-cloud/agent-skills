    ...
    services:
      api:
        ...
        env:
          ...
          # → postgresql://postgres:pass@my-app-database-k7xm9p2q.pg.hostess.run:5432/database?sslmode=require
...
| `${db.external_url}` | External connection URL with credentials | `postgresql://postgres:pass@my-app-db-k7xm9p2q.pg.hostess.run:5432/database?sslmode=require` |
...
services:
  api:
    ...
    env:
      ...
      # → rediss://my-app-cache-p2x8k4n7.default:pass@redis.hostess.run:6379/0
...
| `${cache.external_url}` | External connection URL | `rediss://my-app-cache-p2x8k4n7.default:pass@redis.hostess.run:6379/0` |
