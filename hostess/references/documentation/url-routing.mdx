---
title: URL Routing
description: How Hostess generates and routes URLs for your services — stable URLs, deployment URLs, multi-port, and custom domains.
---
...
These URLs use HTTPS with certificates provisioned automatically.
...
- **Deploy output** — After a successful `hostess deploy`, the CLI prints public service URLs.
...
After deploying a public service:
...
See [Custom Domains](https://docs.hostess.sh/docs/custom-domains) for the full setup guide, including DNS configuration and TLS certificates.
