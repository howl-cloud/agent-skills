...
✓ Deployment complete
  ...
  metabase: https://metabase-metabase-fresh-moss.hostess.run
```
</Step>
...
```text
https://metabase-metabase-fresh-moss.hostess.run
```
...
```bash title="Terminal"
curl https://metabase-metabase-fresh-moss.hostess.run/api/health
```
