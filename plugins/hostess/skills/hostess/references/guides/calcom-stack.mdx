...
✓ Deployment complete
  ...
  calcom: https://calcom-calcom-warm-stone.hostess.run
```
</Step>
...
```text
https://calcom-calcom-warm-stone.hostess.run
```
...
```bash title="Terminal"
curl -I https://calcom-calcom-warm-stone.hostess.run
```
...
- **[Managing Secrets](/guides/managing-secrets)** - Rotate Cal.com and SMTP secrets safely
- **[Backups & Restore](/guides/backups-and-restore)** - Protect the Cal.com Postgres database
- **[Custom Domains](/guides/custom-domains)** - Put your own domain in front of Cal.com
