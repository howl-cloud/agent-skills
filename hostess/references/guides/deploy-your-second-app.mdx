...
This guide assumes you have the Hostess CLI installed and are logged in. If not, follow [Deploy Your First App](/guides/deploy-your-first-app) first.
...
- **[Next.js + FastAPI + Postgres](/guides/nextjs-fastapi-postgres)** — Add a frontend and database to your API
- **[Managing Secrets](/guides/managing-secrets)** — Store API keys and credentials securely
- **[Custom Domains](/guides/custom-domains)** — Point your own domain at your services
