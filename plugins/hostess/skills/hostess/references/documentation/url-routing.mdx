...
|---|---|---|
| Stable URL | `https://{project}-{service}-{slug}.hostess.run` | Public or team service traffic |
| Deployment URL | `https://{project}-{service}-{shortSHA}.hostess.run` | PR previews, rollback verification |
| Multi-port URL | `https://{project}-{service}-{slug}-{N}.hostess.run` | Additional public or team ports |
